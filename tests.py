...
def get_parser():
    ...
    # Warnings argument
    prs.add_argument(
        "-w", action="store_true", help="Display warnings emitted during tests"
    )
    ...
    prs.add_argument(
        AP.PFX.format(AP.LOCAL),
        "-l",
        action="store_true",
        help="Run all local tests (not requiring Internet " "access)",
    )
    prs.add_argument(
    ...
    # TestAll group
    gp_testall.add_argument(
        AP.PFX.format(AP.TESTALL),
        action="store_true",
    ...
    # CLI group
    gp_cli.add_argument(
        AP.PFX.format(AP.CLI), action="store_true", help="Run all CLI tests"
    )
    gp_cli.add_argument(
        AP.PFX.format(AP.CLI_LOCAL),
        action="store_true",
        help="Run all local CLI tests",
    )
    gp_cli.add_argument(
        AP.PFX.format(AP.CLI_GOOD),
        action="store_true",
        help="Run expect-good CLI tests",
    )
    gp_cli.add_argument(
        AP.PFX.format(AP.CLI_GOOD_LOCAL),
        action="store_true",
        help="Run local expect-good CLI tests",
    )
    gp_cli.add_argument(
        AP.PFX.format(AP.CLI_FAIL),
        action="store_true",
        help="Run expect-fail CLI tests",
    )
    gp_cli.add_argument(
        AP.PFX.format(AP.CLI_FAIL_LOCAL),
        action="store_true",
    ...
    # API group
    gp_api.add_argument(
        AP.PFX.format(AP.API), action="store_true", help="Run all API tests"
    )
    gp_api.add_argument(
        AP.PFX.format(AP.API_LOCAL),
        action="store_true",
        help="Run all local API tests",
    )
    gp_api.add_argument(
        AP.PFX.format(AP.API_GOOD),
        action="store_true",
        help="Run expect-good API tests",
    )
    gp_api.add_argument(
        AP.PFX.format(AP.API_GOOD_LOCAL),
        action="store_true",
        help="Run local expect-good API tests",
    )
    gp_api.add_argument(
        AP.PFX.format(AP.API_FAIL),
        action="store_true",
...
def main():
    ...
    # Expect-good tests
    addsuiteif(
        sphobjinv.test.sphobjinv_api.suite_api_expect_good(),
        [
            AP.ALL,
            AP.LOCAL,
            AP.GOOD,
    ...
    addsuiteif(
        sphobjinv.test.sphobjinv_api.suite_api_expect_good_nonlocal(),
        [AP.ALL, AP.GOOD, AP.API, AP.API_GOOD],
    )
    addsuiteif(
        sphobjinv.test.sphobjinv_cli.suite_cli_expect_good(),
        [
            AP.ALL,
            AP.LOCAL,
            AP.GOOD,
    ...
    addsuiteif(
        sphobjinv.test.sphobjinv_cli.suite_cli_expect_good_nonlocal(),
        [AP.ALL, AP.GOOD, AP.CLI, AP.CLI_GOOD],
    )

    # Expect-fail tests
    addsuiteif(
        sphobjinv.test.sphobjinv_api.suite_api_expect_fail(),
        [AP.ALL, AP.LOCAL, AP.FAIL, AP.API, AP.API_LOCAL, AP.API_FAIL],
    )
    addsuiteif(
        sphobjinv.test.sphobjinv_cli.suite_cli_expect_fail(),
        [
            AP.ALL,
            AP.LOCAL,
            AP.FAIL,
    ...
    addsuiteif(
        sphobjinv.test.sphobjinv_cli.suite_cli_expect_fail_nonlocal(),
        [AP.ALL, AP.FAIL, AP.CLI, AP.CLI_FAIL],
    )

    # README doctest
    addsuiteif(
        sphobjinv.test.sphobjinv_readme.suite_doctest_readme(),
        [AP.ALL, AP.README],
    )
