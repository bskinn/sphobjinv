...
# -*- coding: utf-8 -*-
#
# Sphinx Objects.inv Converter documentation build configuration file, created by
...
# Travis-CI needs a lower version to handle doctest on Py3.3
needs_sphinx = '1.4' if os.environ.get('TRAVIS') else '1.6'
...
#html_title = 'Sphinx Objects.inv Converter v1.0'
